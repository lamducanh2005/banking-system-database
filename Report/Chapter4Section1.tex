...
\begin{enumerate}[label=\alph*.]
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{accounts.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{customers.png}
        \caption{Bảng customers}
    \end{figure}

    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{employees.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{transactions.png}
